...
* **[appdirs](https://pypi.org/project/appdirs/)** // the module that makes cross-platform game config and data storing in users directories possible
...
* **[rich](https://pypi.org/project/rich/)** // the module that makes displaying markdown files in terminal possible
